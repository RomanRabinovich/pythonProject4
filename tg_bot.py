...
async def start(message: types.Message):
    ...
    await message.answer("Lenta novostei", reply_markup=keyboard)
...
async def get_fresh_news(message: types.Message):
    ...
    if len(fresh_news) >= 1:
        ...
        await message.answer("Bro, no any fresh news...")
...
async def news_every_minute():
    while True:
        ...
        if len(fresh_news) >= 1:
            ...
            await bot.send_message(user_id, "Bro, no any fresh news...", disable_notification=True)
